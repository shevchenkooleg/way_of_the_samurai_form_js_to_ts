        ...
        dialogsPage: {
            ...
            messages: [
                ...
                {id: 3, userId: 1, message: 'Whats the news?', avatarImage: avaLinkArray[1]},
                {
                    id: 4,
                    userId: 0,
                    message: 'Oh. Everything great! I am already done my couse project by the biology)',
                    avatarImage: avaLinkArray[0]
                },
                {
                    id: 5,
                    userId: 1,
                    message: 'Sound great! Perhaps now you\'ll got much more free time to spend with me)',
                    avatarImage: avaLinkArray[1]
                },
            ...
            this._state.profilePage.posts.unshift(
                {
                    ...
                    userId: 0,
                    post: store._state.profilePage.newPostText,
                    likeCount: 0
                }
            )
            ...
            this._state.dialogsPage.messages.push(
                {
                    ...
                    avatarImage: this._avaLinkArray[0]
                }
            )
            this._state.dialogsPage.newMessageText = ''
            this._callSubscriber(store)
        } else if (action.type === NEW_POST_TEXT_AREA_UPDATE) {
            this._state.profilePage.newPostText = action.newText
            this._callSubscriber(store)
        } else if (action.type === NEW_MESSAGE_TEXT_AREA_UPDATE) {
